...
### <a name="M2"></a>Main Talk 2

**Finding and using open source software metrics through dependencies with Libraries.io**<br/>
Andrew Nesbitt, Libraries.io<br/>

For the past 18 months I've been working to map out the dependency graph of all of open source, indexing libraries from over 30 package managers and parsing package manager manifest files in over 10 million open source projects to try and answer that question.
 
All of this data has been collected by the open source, community focused project, Libraries.io, which focuses on collecting, normalizing and providing linked metadata for open source projects in a normalized format across many languages and platforms so it can easily be used to help improve the open source community.
 
This data, provided in a variety of open formats, is perfect for use many different research, commercial and scholarly projects such as: 
 
- Highlighting important libraries that might need support
- Software citation linking and contribution acknowledgment
- License usage throughout different software communities
- Investigating how security vulnerabilities can affect transitive dependencies
 
In this talk I'll about why I started collecting all this data, examples of how it's being used and look at how it could be built on in the future to help with the issues of sustainability and security in open source software.
...
**UK-RSE Discussion Session**<br/>

This will be a discussion session, paired with session T4.5, allowing you to ask questions about UK-RSE, and for the UK-RSE community to come together to talk about important events.
...
### <a name="T4.5"></a>Talk 4.5

**UK-RSE Discussion Session**<br/>

This will be a discussion session, paired with session T3.5, allowing you to ask questions about UK-RSE, and for the UK-RSE community to come together to talk about important events.
...
Newcastle University's Digital Institute has been championing the importance of quality software for cross-disciplinary research since its creation 8 years ago. The number of research software engineers has grown steadily over time and has become a key role within the group. The Digital Instituteâ€™s primary aim is to transform research across the University through the design and use of innovative digital technologies. The Digital Institute was recently awarded Â£30m to build a new National Institute for Smart Data Innovation.
